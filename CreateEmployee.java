package SubjectivePracticeTest;
...
public class CreateEmployee {
	...
	public void createEmployee() throws InterruptedException, IOException 
	{
	    ...
	    driver.findElement(By.xpath("//input[@id='firstName']")).sendKeys("Nookala");
	    driver.findElement(By.xpath("//input[@id='lastName']")).sendKeys("Mounika");
	    ...
	    driver.findElement(By.xpath("//input[@id='empsearch_employee_name_empName']")).sendKeys("Nookala Mounika");
